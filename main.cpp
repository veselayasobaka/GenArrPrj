...
int main(int argc, char *argv[])
{
    ...
    int32_t left_border_int, right_border_int;
    float left_border_float, right_border_float;
    cout << "Welcome to Generation Random Array Program v0.1! This progam is build to generate random arrays of different type of "
            ...
            "(current maximum length is 10000 numbers)" << endl << "Please choose one of avaliable types: enter 'i' for int ("
    ...
    if (array_length <= 10000)
        ...
        cout << "The array length could be from 0 to 10000 only!" << endl;
    return 0;
}
